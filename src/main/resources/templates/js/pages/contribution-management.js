...
$(document).ready(async function () {
    ...
    // Bảng đóng góp quỹ        
    dataTable = $('#contribution-management-table').DataTable({
        fixedHeader: true,
        autoWidth: false,
        processing: true,
        paging: true,
...
$('#contribution-management-table tbody').on('click', 'tr', function () {
...
// Nhấn nút "Xác nhận"
$("#btn-confirm-contribute").on("click", async function () {
    if (!selectedData) {
        Toast.fire({
            icon: "error",
